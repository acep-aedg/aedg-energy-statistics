...
monthly_sales_url = 'https://github.com/acep-uaf/ak-energy-statistics-2011_2021/raw/refs/heads/ian/add-monthly-sales-data/workbooks/sales_monthly_pce_eia_consolidated.xlsx'
